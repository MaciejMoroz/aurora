...
var Slider = function Slider(elemSelector, opts) {
  var defaultOpts = {
    pauseTime: 0,
...
Slider.prototype.generateSlider = function () {
  ...
  this.slider.classList.add("slider"); //contener for slides

  var slidesCnt = document.createElement("div");
  slidesCnt.classList.add("slider-slides-cnt"); //slide element
